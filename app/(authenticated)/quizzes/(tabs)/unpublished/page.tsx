...
interface UnpublishedQuizzesProps {}

const UnpublishedQuizzes: FunctionComponent<UnpublishedQuizzesProps> = () => {
  return (
    <TabsContent value={Routes.UNPUBLISHED}>
...
export default UnpublishedQuizzes;
